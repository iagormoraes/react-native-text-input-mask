...
import { TextInput, findNodeHandle, NativeModules, Platform } from "react-native";
...
export default class TextInputMask extends Component {
    ...
    componentDidMount() {
        if (this.props.maskDefaultValue && this.props.mask && this.props.value) {
            mask(this.props.mask, "" + this.props.value, text => this.input && this.input.setNativeProps({ text }));
        }
